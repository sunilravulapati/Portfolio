      ...
      <Reveal>
        <div className="relative z-10 space-y-6 text-white">
          ...
          <p className="text-lg leading-relaxed">
            Hello! I&rsquo;m <span className="font-semibold text-cyan-400">Sunil Ravulapati</span>, a dedicated{' '}
          ...
          <p className="text-lg leading-relaxed">
            ...
            new tech trends and design patterns. I&rsquo;m deeply interested in emerging fields like{' '}
          ...
          <p className="text-lg leading-relaxed">
            Let&rsquo;s connect and build something impactful!
          </p>
        </div>
      </Reveal>
    </section>
